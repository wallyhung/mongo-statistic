...
public class IPSeeker {
	...
	private static String bad_ip_file = "ip文件损坏";
	private static String unknown_country = "不知名国家或机构";
	private static String unknown_area = "不知名地区";
	...
	private IPSeeker()  {
		...
		try 
		{
//			IP_FILE = Util.getResource(IP_FILE, IPSeeker.class).getFile();
			IP_FILE = "d:/bin/adstatistic/lib/qqwry.dat";
	...
	public static void main(String[] args) {
		...
		String ip = "124.202.227.78";
		
//		List<IPEntry> ret = seeker.getIPEntries("北京");
//		for (IPEntry ipEntry : ret) {
//			System.out.println(ipEntry.beginIp + "---" + ipEntry.endIp);
//		}
